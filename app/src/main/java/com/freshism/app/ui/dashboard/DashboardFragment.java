...
public class DashboardFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // Manual
        // Manual Switch
        binding.switchManual.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (value != null) {
                    if (value.equals("1")) {
                        ...
                        if (binding != null) {
                            binding.switchManual.setChecked(true);
                        }
                    } else if (value.equals("0")) {
                        // Nilai false (OFF), tombol "OFF" diklik
                        if (binding != null) {
                            binding.switchManual.setChecked(false);
                        }
                    }
                }
            }
